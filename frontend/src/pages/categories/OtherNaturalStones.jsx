              ...
              {filteredProducts.length > itemsPerPage && (
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      padding: '10px 16px',
                      backgroundColor: currentPage === 1 ? '#ccc' : '#b48e5d',
                      color: 'white',
                      border: 'none',
                      borderRadius: '6px',
                    ...
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                      <button
                        ...
                        style={{
                          ...
                          padding: '8px 12px',
                          borderRadius: '6px',
                          border: currentPage === page ? '2px solid #b48e5d' : '1px solid #ddd',
                          backgroundColor: currentPage === page ? '#b48e5d' : 'white',
                  ...
                  <button
                    ...
                    style={{
                      padding: '10px 16px',
                      backgroundColor: currentPage === totalPages ? '#ccc' : '#b48e5d',
                      color: 'white',
                      border: 'none',
                      borderRadius: '6px',
