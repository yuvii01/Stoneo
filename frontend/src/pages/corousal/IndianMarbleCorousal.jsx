...
const originalItems = [
    { id: "im1", name: "Black",  color: "#1a1a1a", url: "https://www.bhandarimarblecompany.com/wp-content/uploads/2024/05/Tobacco-black-marble-300x238.png" },
    { id: "im2", name: "White",  color: "#d6d6d6", url: "https://www.bhandarimarblecompany.com/wp-content/uploads/2024/05/Agaria-white-marble-300x229.png" },
    { id: "im3", name: "Brown",  color: "#7b4f2e", url: "https://www.bhandarimarblecompany.com/wp-content/uploads/2024/05/Brown-rainforest-marble-300x247.png" },
    { id: "im4", name: "Red",    color: "#b52a2a", url: "https://www.bhandarimarblecompany.com/wp-content/uploads/2024/05/Oman-red-marble-300x287.png" },
    { id: "im5", name: "Yellow", color: "#d4b400", url: "https://www.bhandarimarblecompany.com/wp-content/uploads/2024/05/jaisalmer-Yellow-marble-300x249.png" },
    { id: "im6", name: "Pink",   color: "#d4607a", url: "https://www.bhandarimarblecompany.com/wp-content/uploads/2024/05/Pink-marble-300x209.png" },
    { id: "im7", name: "Grey",   color: "#7a7a7a", url: "https://www.bhandarimarblecompany.com/wp-content/uploads/2024/05/Ardosia-black-marble-300x264.png" },
    { id: "im8", name: "Green",  color: "#2e7d32", url: "https://www.bhandarimarblecompany.com/wp-content/uploads/2024/05/Keshairya-green-marble-300x280.png" },
  ];
...
/* ─── Main Component ─────────────────────────────────────── */
export default function MarbleCarousel() {
    ...
    <>
      ...
      >
        ...
        <div className="gc-header">
           ...
           {/* <p style={{ color: "#a45040", letterSpacing: "4px", fontWeight: "bold", fontSize: "12px", marginBottom: "8px" }}>
          [ OUR PREMIUM SELECTION ]
        </p>
        <h2>Indian Marble Collection</h2> */}

          <p className="gc-eyebrow">[ Our Premium Selection ]</p>
          <h2 className="gc-title">Indian Marble Collection</h2>
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    ...
                    navigate(`/category/Indian_Marble?category=${encodeURIComponent(item.name.trim())}`)
                    pausedRef.current = true;
        ...
        <div className="gc-nav">
         ...
         <div style={{ display: "flex", justifyContent: "center" }}>
          <button
            ...
            onClick={() => navigate("/category/Indian_Marble")}
          >
            View All Indian Marbles
          </button>
        </div>
      </section>
    </>
