...
export default function AdminHomeDecor() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const data = res.data || [];
            const standardProducts = data.filter(p => !p.isRoyalGemStone && p.category === 'Home Decor');
    ...
    const handleEdit = async (product) => {
        ...
        try {
            ...
            setFormData({
                ...
                category: fullProduct.category || 'Home Decor',
    ...
    return (
        <div style={{ maxWidth: '1050px', margin: '0 auto', padding: '10px 15px 60px' }}>
            <div className="admin-page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                <div>
                    <h1 className="admin-page-title" style={{ margin: 0 }}>Manage Home Decor</h1>
                    <p style={{ margin: '4px 0 0 0', color: '#666', fontSize: '14px' }}>
                        Create and manage Home Decor items
                    </p>
                </div>
            ...
            {showForm && (
                <div className="admin-form-container" style={{
                    ...
                    <h2 style={{ marginBottom: '20px', fontSize: '22px', color: '#111' }}>
                        {editingId ? 'Edit Home Decor Details' : 'Create Home Decor Product'}
                    </h2>
